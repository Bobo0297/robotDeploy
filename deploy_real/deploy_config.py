...
class Sim2SimConfig():
    ...
    class robot_config:
        kps = np.array([# 双腿kps
            ...
            90, 60, 20, 60, 20, 20, 20], dtype=np.float32)
        ...
        kds = np.array([# 双腿kds
            ...
            2.0, 1.0, 0.4, 1.0, 1.0, 1.0, 1.0], dtype=np.float32)
        ...
        dof_idx = np.array([# 双腿
            ...
            12, 13, 14,
            15, 16, 17, 18,
            22, 23, 24, 25], dtype=np.int32)
        
        other_dof_idx = np.array([19, 20, 21, 26, 27, 28], dtype=np.int32)
        ...
        num_obs = num_obs_without_history + history_length * 23
