import os
DEPLOY_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
ROBOT = "g1" # Robot name, "go2", "b2", "b2w", "h1", "go2w", "g1" 
ROBOT_SCENE = DEPLOY_ROOT + "/resources/robots/" + ROBOT + "/scene_29dof.xml" # Robot scene
